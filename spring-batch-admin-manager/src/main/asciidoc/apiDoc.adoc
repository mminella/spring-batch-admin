...
==== Request parameters
Additional parameters besides the file parameter itself.
...
include::{snippets}/file-upload-request-path/path-parameters.adoc[]

==== Example request

include::{snippets}/file-upload-request-path/curl-request.adoc[]

==== Response structure

include::{snippets}/file-upload-request-path/response-fields.adoc[]

==== Example Response

include::{snippets}/file-upload-request-path/http-response.adoc[]
